    ...
    match (left, index) {
        (Object::Array(arr), Object::Integer(idx)) => {
            ...
            let slot = elements.get_mut(i as usize).ok_or_else(|| ErrorObject {
                msg: format!(
                    "index {i} out of bounds for Array of length {len}, use `.push()` to append"
                ),
            })?;
...
mod tests {
    ...
    const CASES: &[Case] = &[
        ...
        Case {
            ...
            output: "ERROR: index 5 out of bounds for Array of length 3, use `.push()` to append",
        },
        Case {
        ...
        Case {
            name: "array_rest_empty",
            input: "[].rest()",
            output: "[]",
        },
        Case {
            name: "array_rest_is_independent",
            input: "let a = [1, 2]; let b = a.rest(); b.push(3); print(a); b;",
            output: "[1, 2][2, 3]",
        },
        Case {
            name: "array_pop_mutates_alias",
            input: "let a = [1, 2]; let b = a; print(b.pop()); a;",
            output: "2[1]",
        },
        Case {
            name: "err_array_stdlib_class_replaced",
            input: "Array = null; [].len();",
            output: "ERROR: internal eval error: stdlib class `Array` is not defined; the abclang prelude may not have been loaded",
        },
        Case {
            name: "err_array_first_no_args",
            input: "__INTERNALS_array_first()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_first`. got=0, want=1",
        },
        Case {
            name: "err_array_first_extra_args",
            input: "__INTERNALS_array_first([], null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_first`. got=2, want=1",
        },
        Case {
            name: "err_array_first_invalid_receiver",
            input: "__INTERNALS_array_first(1)",
            output: "ERROR: arguments to `__INTERNALS_array_first` not supported, expected array, got Integer",
        },
        Case {
            name: "err_array_last_no_args",
            input: "__INTERNALS_array_last()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_last`. got=0, want=1",
        },
        Case {
            name: "err_array_last_extra_args",
            input: "__INTERNALS_array_last([], null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_last`. got=2, want=1",
        },
        Case {
            name: "err_array_last_invalid_receiver",
            input: "__INTERNALS_array_last(1)",
            output: "ERROR: arguments to `__INTERNALS_array_last` not supported, expected array, got Integer",
        },
        Case {
            name: "err_array_rest_no_args",
            input: "__INTERNALS_array_rest()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_rest`. got=0, want=1",
        },
        Case {
            name: "err_array_rest_extra_args",
            input: "__INTERNALS_array_rest([], null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_rest`. got=2, want=1",
        },
        Case {
            name: "err_array_rest_invalid_receiver",
            input: "__INTERNALS_array_rest(1)",
            output: "ERROR: arguments to `__INTERNALS_array_rest` not supported, expected array, got Integer",
        },
        Case {
            name: "err_array_pop_no_args",
            input: "__INTERNALS_array_pop()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_pop`. got=0, want=1",
        },
        Case {
            name: "err_array_pop_extra_args",
            input: "__INTERNALS_array_pop([], null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_pop`. got=2, want=1",
        },
        Case {
            name: "err_array_pop_invalid_receiver",
            input: "__INTERNALS_array_pop(1)",
            output: "ERROR: arguments to `__INTERNALS_array_pop` not supported, expected array, got Integer",
        },
        Case {
            name: "err_array_len_no_args",
            input: "__INTERNALS_array_len()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_len`. got=0, want=1",
        },
        Case {
            name: "err_array_len_extra_args",
            input: "__INTERNALS_array_len([], null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_len`. got=2, want=1",
        },
        Case {
            name: "err_array_len_invalid_receiver",
            input: "__INTERNALS_array_len(1)",
            output: "ERROR: argument to `__INTERNALS_array_len` not supported, expected Array, got Integer",
        },
        Case {
            name: "err_array_push_no_args",
            input: "__INTERNALS_array_push()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_push`. got=0, want=2",
        },
        Case {
            name: "err_array_push_missing_value",
            input: "__INTERNALS_array_push([])",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_push`. got=1, want=2",
        },
        Case {
            name: "err_array_push_extra_args",
            input: "__INTERNALS_array_push([], null, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_array_push`. got=3, want=2",
        },
        Case {
            name: "err_array_push_invalid_receiver",
            input: "__INTERNALS_array_push(1, null)",
            output: "ERROR: argument to `__INTERNALS_array_push` not supported, expected Array, got Integer",
        },
        // hash
        Case {
            name: "hash_index_hit",
        ...
        Case {
            name: "len_hash_builtin",
            input: r#"len({"a": 1, "b": null})"#,
            output: "2",
        },
        Case {
            name: "len_empty_hash_builtin",
            input: "len({})",
            output: "0",
        },
        Case {
            name: "hash_unhashable_keys_do_not_mutate",
            input: r#"let h = {"a": 1}; print(h.has([]), h.has({}), h.has(null)); print(h.remove([]) == null, h.remove({}) == null, h.remove(null) == null); h.len();"#,
            output: "false false falsetrue true true1",
        },
        Case {
            name: "hash_remove_mutates_alias",
            input: r#"let h = {"a": 1}; let alias = h; print(alias.remove("a")); print(h.has("a")); h.len();"#,
            output: "1false0",
        },
        Case {
            name: "empty_hash_keys_and_values",
            input: "print({}.keys()); {}.values();",
            output: "[][]",
        },
        Case {
            name: "err_hash_stdlib_class_replaced",
            input: "HashMap = null; {}.len();",
            output: "ERROR: internal eval error: stdlib class `HashMap` is not defined; the abclang prelude may not have been loaded",
        },
        Case {
            name: "err_hash_len_no_args",
            input: "__INTERNALS_hash_len()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_len`. got=0, want=1",
        },
        Case {
            name: "err_hash_len_extra_args",
            input: "__INTERNALS_hash_len({}, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_len`. got=2, want=1",
        },
        Case {
            name: "err_hash_len_invalid_receiver",
            input: "__INTERNALS_hash_len(1)",
            output: "ERROR: argument to `__INTERNALS_hash_len` not supported, expected Hash, got Integer",
        },
        Case {
            name: "err_hash_has_no_args",
            input: "__INTERNALS_hash_has()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_has`. got=0, want=2",
        },
        Case {
            name: "err_hash_has_missing_key",
            input: "__INTERNALS_hash_has({})",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_has`. got=1, want=2",
        },
        Case {
            name: "err_hash_has_extra_args",
            input: "__INTERNALS_hash_has({}, null, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_has`. got=3, want=2",
        },
        Case {
            name: "err_hash_has_invalid_receiver",
            input: "__INTERNALS_hash_has(1, null)",
            output: "ERROR: argument to `__INTERNALS_hash_has` not supported, expected Hash, got Integer",
        },
        Case {
            name: "err_hash_remove_no_args",
            input: "__INTERNALS_hash_remove()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_remove`. got=0, want=2",
        },
        Case {
            name: "err_hash_remove_missing_key",
            input: "__INTERNALS_hash_remove({})",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_remove`. got=1, want=2",
        },
        Case {
            name: "err_hash_remove_extra_args",
            input: "__INTERNALS_hash_remove({}, null, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_remove`. got=3, want=2",
        },
        Case {
            name: "err_hash_remove_invalid_receiver",
            input: "__INTERNALS_hash_remove(1, null)",
            output: "ERROR: argument to `__INTERNALS_hash_remove` not supported, expected Hash, got Integer",
        },
        Case {
            name: "err_hash_keys_no_args",
            input: "__INTERNALS_hash_keys()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_keys`. got=0, want=1",
        },
        Case {
            name: "err_hash_keys_extra_args",
            input: "__INTERNALS_hash_keys({}, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_keys`. got=2, want=1",
        },
        Case {
            name: "err_hash_keys_invalid_receiver",
            input: "__INTERNALS_hash_keys(1)",
            output: "ERROR: argument to `__INTERNALS_hash_keys` not supported, expected Hash, got Integer",
        },
        Case {
            name: "err_hash_values_no_args",
            input: "__INTERNALS_hash_values()",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_values`. got=0, want=1",
        },
        Case {
            name: "err_hash_values_extra_args",
            input: "__INTERNALS_hash_values({}, null)",
            output: "ERROR: wrong number of arguments to `__INTERNALS_hash_values`. got=2, want=1",
        },
        Case {
            name: "err_hash_values_invalid_receiver",
            input: "__INTERNALS_hash_values(1)",
            output: "ERROR: argument to `__INTERNALS_hash_values` not supported, expected Hash, got Integer",
        },
        // print
        Case {
            name: "print_basic",
