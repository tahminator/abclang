...
impl Lexer {
    ...
    fn scan_token(&mut self) -> Result<Token, LexerError> {
        ...
        let tok = match self.ch {
            ...
            _ if is_digit(self.ch) => return self.read_number(),
            _ => Token {
                literal: EMPTY.into(),
    ...
    fn read_number(&mut self) -> Result<Token, LexerError> {
        ...
        if self.ch == b'.'
            && is_digit(
                self.peek_char()
                    .ok_or(LexerError::FailedToFindDigitsAfterPeriodOnFloat)?,
            )
        {
            is_float = true;
            self.read_char();
        ...
        let num = self.input[pos..self.pos].as_str()?;

        let typ = match is_float {
...
";
    ...
    #[test]
    fn test_next_token_real_scenario5_with_hashmap() {
        let input = "let five = 5;
let ten = 10;
...
";
    ...
    #[test]
    fn test_next_token_real_scenario6() {
        let input = "let five = 5;
let ten = 10;
...
";
    ...
    #[test]
    fn test_next_token_real_scenario7() {
        let input = "let five = 5;
let ten = 10;
...
";
    ...
    #[test]
    fn test_next_token_real_scenario8() {
        let input = "let five = 5;
let ten = 10;
